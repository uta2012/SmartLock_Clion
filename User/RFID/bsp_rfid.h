...
#define RIFD_RES_SET()      HAL_GPIO_WritePin(RFID_SPI3_RST_GPIO_Port, RFID_SPI3_RST_Pin, GPIO_PIN_SET)
#define RIFD_RES_RESET()    HAL_GPIO_WritePin(RFID_SPI3_RST_GPIO_Port, RFID_SPI3_RST_Pin, GPIO_PIN_RESET)
#define RIFD_CS_SET()       HAL_GPIO_WritePin(RFID_SPI3_CS_GPIO_Port, RFID_SPI3_CS_Pin, GPIO_PIN_SET)
#define RIFD_CS_RESET()	    HAL_GPIO_WritePin(RFID_SPI3_CS_GPIO_Port, RFID_SPI3_CS_Pin, GPIO_PIN_RESET)
...
extern uint8_t CardId[4];  				//卡号
extern uint8_t CardType[2];//卡类型
extern uint8_t writeDataBuf[16];
